...
export function downloadAveragesPdf(
  ...
  doc.setFontSize(14);
  doc.setTextColor(0);
  doc.text("Business Responsibility and Sustainability Report", 105, 20, {
    align: "center",
  });
  doc.setFontSize(12);
  doc.text("Department of Post", 105, 28, { align: "center" });
  ...
  doc.text(`Manager Name: ${managerName}`, 20, infoY + 10);
  doc.text(`Address: ${data.address || "N/A"}`, 20, infoY + 20);
